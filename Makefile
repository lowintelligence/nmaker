...
CC=mpiicc
MICCC=icc
CFLAGS=$(STATIC) -xHost -fimf-domain-exclusion=15 -O3 $(DEBUG) $(NAIVE) $(PRECISION) $(OPENMP) $(NO_OFFLOAD) $(FFTDEF) -g -traceback -Bdynamic -fno-omit-frame-pointer 
CFLAGSMIC=-mmic -fimf-domain-exclusion=15 -O3 $(DEBUG) $(NAIVE) $(PRECISION) $(OPENMP) -g -traceback -Bdynamic -fno-omit-frame-pointer
